...
export default function Templates() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/car-options")
      ...
      .catch((error) => console.error("Error fetching car options:", error));
  }, []);
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-12">
                        ...
                        >
                          ...
                          {options.carTypes.map((type, index) => (
                      ...
                      <div className="col-md-12">
                        <select
                          ...
                          onChange={handleChange}
                        >
                          <option value="">Price of Rent</option>
                          {options.rentPrices.map((price, index) => (
                        ...
                        <div className="our cross_layout">
                          <div className="test_box">
                            ...
                            <p>
                              ...
                              dolor in reprehenderit in voluptate velit ess
                            </p>
                            <i>
                              <img src={te1} alt="#" />
                            </i>
